...
def train_node_classifier(
    ...
    with EarlyStopping(
        cfg.patience,
        verbose=True,
        path=Path(os.getcwd())/"checkpoints"/ (str(uuid.uuid4())+"checkpoint.pt"),
        ...
        for e in range(n_epochs):
            ...
            log.info(
                ...
                f"{train_loss=:.3f}, train_acc={eval_results['train_acc']:.3f}, "
                f"val_loss={eval_results['val_loss']:.3f}, val_acc={eval_results['val_acc']:.3f}"
            )
