...
Welcome to `graph_description` contributor's guide.
...
If you experience bugs or general issues with `graph_description`, please have a look
...
You can help improve `graph_description` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`graph_description` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `graph_description`'s files. While this mechanism can
...
```
conda create -n graph_description python=3 six virtualenv pytest pytest-cov
conda activate graph_description
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/graph_description.git
   cd graph_description
   ```
...
5. Install [pre-commit]:
   ...
   `graph_description` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/graph_description
[issue tracker]: https://github.com/<USERNAME>/graph_description/issues
